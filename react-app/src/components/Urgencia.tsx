  ...
  return (
    <section style={{ position: 'relative', padding: 'clamp(70px,10vw,130px) clamp(20px,4vw,48px)', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', maxWidth: '880px', margin: '0 auto', textAlign: 'center' }}>
        <img src="/assets/athlas-logo.png" alt="Athlas, mascote da Argo Tecnologia" style={{ height: '96px', width: 'auto', marginBottom: '24px', filter: 'drop-shadow(0 12px 30px rgba(91,140,255,.5))', animation: 'floaty 5.5s ease-in-out infinite' }} />
